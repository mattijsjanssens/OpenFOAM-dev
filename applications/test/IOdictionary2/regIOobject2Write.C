...
Description
    write function for regIOobject2s
...
bool Foam::regIOobject2::writeObject
(
...
) const
{
    ...
    {
        const_cast<regIOobject2&>(*this).instance() = time().timeName();
    }
...
bool Foam::regIOobject2::write() const
{
    return writeObject
    (
        time().writeFormat(),
